		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(testAPIGatewayAPIKeysDataSourceName+".name", "list.0.id"),
					...
					resource.TestCheckResourceAttrSet(testAPIGatewayAPIKeysDataSourceName+".id", "list.0.id"),
